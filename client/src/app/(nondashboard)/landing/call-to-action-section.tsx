        ...
        <div className="flex flex-col md:flex-row justify-between items-center">
          ...
          <div>
            <p className="text-white mb-3">
              Discover a wide range of rental properties in your disired
              location.
            </p>
            <div className="flex justify-center md:justify-start gap-4">
              <button
                ...
                className="inline-block px-6 py-3 text-primary-700 bg-white rounded-lg font-semibold hover:bg-primary-500 hover:text-primary-50"
              >
                Search
              </button>
