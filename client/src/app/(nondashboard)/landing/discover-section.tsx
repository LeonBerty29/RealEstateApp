      ...
      <div className="max-w-6xl xl:max-w-7xl mx-auto px-6 sm:px-8 lg:px-12 xl:px-16">
        ...
        >
            ...
            <p className="mt-2 text-gray-500 max-w-3xl mx-auto">
                ...
                our user-friendly search feature, you can quickly find the perfect home that meets
                all your needs. Start your search today and discover your dream rental property!
            </p>
        </motion.div>
...
const DiscoverCard = ({
    ...
    return (
        <div className="px-4 py-12 shadow-lg rounded-lg bg-primary-50 md:min-h-72">
